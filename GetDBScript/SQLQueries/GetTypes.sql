...
SELECT   
     ...
     ' + tAllColumns.column_definition  + N'  
         ...
         ELSE   
             ...
             + N'; '   
     END AS SqlCreateUdt  
 --     ,userDefinedTableTypes.type_table_object_id
	--  ,userDefinedTypes.*
 ...
 LEFT JOIN sys.types AS systemType   
     ...
     AND systemType.is_user_defined = 0  -- AND userDefinedTypes.system_type_id=userDefinedTypes.user_type_id  
      ...
      (  
          SELECT   
             (  
                 ...
                 OUTER APPLY   
                      (  
                         SELECT   
                             ...
                             ,clmns.is_nullable   
                             ,QUOTENAME(ut.name) AS DATA_TYPE  
                 ...
                 WHERE clmns.object_id ='1856725667'  
  and tComputedProperties.DATA_TYPE<>'sysname'  AND t.system_type_id=t.user_type_id
 ...
 WHERE userDefinedTypes.is_user_defined = 1 AND (userDefinedTableTypes.type_table_object_id is not null OR systemType.system_type_id=systemType.user_type_id)